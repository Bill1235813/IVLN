...
def parse_args():
    ...
    parser.add_argument('--inflection_weighting', action='store_true', default=False, help='weight loss more as trajectory length grows')
    ...
    parser.add_argument('--fix_mm_embedding', action='store_true', default=False)
