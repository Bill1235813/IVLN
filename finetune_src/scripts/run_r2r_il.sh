...
outdir=../saved_models/R2R/vitbase-finetune-il-b8
...
export PYTHONPATH=/data/zhuwangz/Matterport3DSimulator/build:$PYTHONPATH
# train
# vitbase.e2e bert_ckpt_file ../datasets/R2R/trained_models/vitbase-6tasks-pretrain-e2e/model_step_22000.pt
CUDA_VISIBLE_DEVICES=1 python r2r/main.py $flag --eval_first \
...
CUDA_VISIBLE_DEVICES=1 python r2r/main.py $flag \
      --resume_file ../saved_models/R2R/vitbase-finetune-il-b8/ckpts/best_val_unseen \
      --test --submit
