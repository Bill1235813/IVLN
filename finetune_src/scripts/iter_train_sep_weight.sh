...
outdir=../saved_models/R2R/vitbase-finetune-iterative-il-hist-sep-weight-b8
...
# vitbase.e2e resume_file: ../datasets/R2R/trained_models/vitbase-finetune-e2e/ckpts/best_val_unseen
 CUDA_VISIBLE_DEVICES=0 python r2r/main.py $flag \
       --resume_file ../saved_models/R2R/vitbase-finetune-iterative-il-hist-sep-weight-b8/ckpts/best_val_unseen \
       --test --iterative
