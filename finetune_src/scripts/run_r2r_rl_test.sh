...
#      --fix_mm_embedding
      ...
      # --mmvl
      # --latent_dim 128
      # --resume_file ${resume} --resume_optimizer --fast_epoch
      # --iters 100000
      # --log_every 2000
      # --batch_size 2
...
# --eval_first
#CUDA_VISIBLE_DEVICES=1 python -m pdb r2r/main.py $flag  \
...
# vitbase.e2e resume_file: ../datasets/R2R/trained_models/vitbase-finetune-e2e/ckpts/best_val_unseen
 CUDA_VISIBLE_DEVICES=0 python -m pdb r2r/main.py $flag \
       --resume_file ../saved_models/R2R/vitbase-finetune-il-e2e/ckpts/best_val_unseen \
       --test --iterative
#       --submit
