...
outdir=../saved_models/R2R/vitbase-finetune-b8
...
CUDA_VISIBLE_DEVICES='2' python r2r/main.py $flag --eval_first \
...
CUDA_VISIBLE_DEVICES='2' python r2r/main.py $flag \
      --resume_file ../saved_models/R2R/vitbase-finetune-b8/ckpts/best_val_unseen \
      --test --submit
